...
contract FractionalNftVaultV3 is
    Initializable,
    OwnableUpgradeable,
    ...
    UUPSUpgradeable 
{
    ...
    function initialize(uint256 _fee, address _liquidityWallet, uint256 _holdoutPeriod, uint16 _vaultCount) external initializer {
        __Ownable_init();
        __ERC721Holder_init();
    ...
    {}
        ...
        function checkV3() external pure returns(bool) {
        return true;
    }
            function checkagainV3() external pure returns(bool) {
        return true;
    }

                function check33againV3() external pure returns(bool) {
        return true;
    }
                    function check33AagainV3() external pure returns(bool) {
        return true;
    }
